...
3. Initialize diagnostic machine state:
...
Checkpoint after every phase and at least every 10 cells. All agents must write
observations before the main agent reads the merged checkpoint.
...
conflicts, rejected Findings and `projection_stale`. Direct mode may be useful
