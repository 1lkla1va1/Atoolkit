...
- `final_report.md` 是 finalizer 保留产物。Agent 只写 canonical Finding 包与证据；完整闭合时 finalizer 重新渲染 final，未闭合但有已证漏洞时只生成 `draft_report.md`，proof/manifest 失败时两者都不保留。
